...
export const Logs: LogsDetail[] = [
  {
    ...
    description: [
      "An introduction to how your normal site can have a good portfolio indexing, and Google search visibility. In today's log we are going to discuss what is SEO, Metadata, and how you can add all this thing inside your application/website.",
      "I have seen most of the developers neglect the SEO part in their website, and I really don't think its `COOL`, if you own any website you should must add SEO and all other ways which can rank your website on the browser (getting ranked or not is another part of the discussion).",
      "Don't worry if you don't know about SEO because in today's guide I am going to make you take a deep dive in how you can easily integrate SEO, Metadata and all the things which are necessary for the bots to read and rank your profile correctly.",
    ],
